      ...
      <div className="grid-container">
        <div className="grid-x grid-margin-x">
          <div className="cell large-12">
            <ul className="category-ul products columns-3 category-grid-layout-1 product-grid-layout-1 ">
                      ...
                      <Link href="/product">
                        ...
                        >
                          <img
                            width={500}
                            height={700}
                            src="/images/category/items/1.jpg"
                            className
                            alt=""
                            loading="lazy"
                          />
                    ...
                    <div className="product-image">
                      ...
                      >
                        <img
                          width={500}
                          height={700}
                          src="/images/category/items/2.jpg"
                          className
                          alt=""
                          loading="lazy"
                        />
                    ...
                    <Link href="/product">
                      ...
                      >
                        <img
                          width={500}
                          height={700}
                          src="/images/category/items/3.jpg"
                          className
                          alt=""
                          loading="lazy"
                        />
