...
const Cart = () => {
  return (
    <Fragment>
      ...
      <div id="myBody" data-footer-reveal="1" className="page-template-default page page-id-1706 wp-embed-responsive theme-barberry woocommerce-cart woocommerce-page woocommerce-no-js wpb-js-composer js-comp-ver-6.3.0 vc_responsive no-offcanvas-animation header-has-title header-has-overlap catalog-ajax-filter posts-has-parallax bb_classic_notif tag-cloud-default">
        <Header />
                              ...
                              <div className="grid-x cart-cells cart-cells-empty">
                                ...
                                >
                                  ...
                                  <form
                                    ...
                                    method="post"
                                  >
                                    <div className="shop_table shop_table_responsive cart woocommerce-cart-form__contents">
                                      <div className="woocommerce-cart-form__cart-item cart_item">
